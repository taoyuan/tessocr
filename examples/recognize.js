...
// tess.recognize(fixture.image, {lang: fixture.lang, psm: 6, prm: 1, rules: [0, 1, 2]}, function (err, result) {
// tess.recognize(fixture.image, {lang: fixture.lang, psm: 6, prm: 1, rules: [[0, 2]]}, function (err, result) {
  if (err) throw err;
